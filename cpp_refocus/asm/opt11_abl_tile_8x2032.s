	.file	"opt11_abl_tile_8x2032.cpp"
...
# options passed: -march=tigerlake -mmmx -mpopcnt -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -mno-sse4a -mno-fma4 -mno-xop -mavx512f -mbmi -mbmi2 -maes -mpclmul -mavx512vl -mavx512bw -mavx512dq -mavx512cd -mavx512vbmi -mavx512ifma -mavx512vpopcntdq -mavx512vbmi2 -mgfni -mvpclmulqdq -mavx512vnni -mavx512bitalg -mno-avx512bf16 -mavx512vp2intersect -mno-3dnow -madx -mabm -mno-cldemote -mclflushopt -mclwb -mno-clzero -mcx16 -mno-enqcmd -mf16c -mfsgsbase -mfxsr -mno-hle -msahf -mno-lwp -mlzcnt -mmovbe -mmovdir64b -mmovdiri -mno-mwaitx -mno-pconfig -mpku -mprfchw -mno-ptwrite -mrdpid -mrdrnd -mrdseed -mno-rtm -mno-serialize -mno-sgx -msha -mshstk -mno-tbm -mno-tsxldtrk -mvaes -mno-waitpkg -mno-wbnoinvd -mxsave -mxsavec -mxsaveopt -mxsaves -mno-amx-tile -mno-amx-int8 -mno-amx-bf16 -mno-uintr -mno-hreset -mno-kl -mno-widekl -mno-avxvnni -mno-avx512fp16 -mno-avxifma -mno-avxvnniint8 -mno-avxneconvert -mno-cmpccxadd -mno-amx-fp16 -mno-prefetchi -mno-raoint -mno-amx-complex -mno-avxvnniint16 -mno-sm3 -mno-sha512 -mno-sm4 -mno-apxf -mno-usermsr -mno-avx10.1 -mno-avx10.2 -mno-amx-avx512 -mno-amx-tf32 -mno-amx-fp8 -mno-movrs -mno-amx-movrs -mno-avx512bmm --param=l1-cache-size=48 --param=l1-cache-line-size=64 --param=l2-cache-size=8192 -mtune=tigerlake -mavx2 -mfma -masm=intel -g -O3 -std=c++17 -ffast-math -fasynchronous-unwind-tables
	.text
.Ltext0:
	.file 0 "/home/team15/tomasz-worktree-dir/cpp_refocus" "src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp"
...
.LVL0:
.LFB11707:
	.file 1 "src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp"
	.loc 1 34 91 view -0
	.cfi_startproc
...
.LBE2127:
.LBE2126:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:34: ImageData refocus_shift_and_sum(std::vector<SubApertureImage>& subapertures, float focus) {
...
.LBE2148:
.LBE2149:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:35:     const size_t width  = subapertures.front().data.width;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:43:     output.data.assign(width * height * 3, 0);
	.loc 1 43 30 is_stmt 0 view .LVU36
	mov	rdx, rax	# _4, _336
	mov	QWORD PTR 256[rsp], rcx	# %sfp, _700
	imul	rdx, rcx	# _4, _700
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:41:     output.width = width;
...
.LBE2262:
.LBE2265:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:37:     const int w = static_cast<int>(width);
	.loc 1 37 15 view .LVU70
	mov	eax, DWORD PTR 160[rsp]	# tmp1753, %sfp
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:38:     const int h = static_cast<int>(height);
...
.LBB2381:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:48:     for (auto& sub : subapertures) {
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:50:         float shift_x = focus * sub.u;
	.loc 1 50 15 is_stmt 0 view .LVU87
	vmovss	xmm5, DWORD PTR 232[rsp]	# focus, %sfp
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:60:         p.x_begin = std::max(0, -p.sx);
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:51:         float shift_y = focus * sub.v;
...
.LBE2275:
.LBE2274:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:52:         p.sx = static_cast<int>(std::floor(shift_x));
...
.LBE2277:
.LBE2276:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:53:         p.sy = static_cast<int>(std::floor(shift_y));
...
.LBE2279:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:61:         p.x_end   = std::min(w, w - p.sx - 1);
...
.LBE2282:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:62:         p.y_begin = std::max(0, -p.sy);
...
.LBE2283:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:63:         p.y_end   = std::min(h, h - p.sy - 1);
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:65:         if (p.x_begin >= p.x_end || p.y_begin >= p.y_end) continue;  // skip degenerate
	...
	jge	.L12	#,
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:55:         float dy = shift_y - p.sy;
	.loc 1 55 15 view .LVU134
	vsubss	xmm5, xmm2, xmm1	# dy, shift_y, _355
.LVL26:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:54:         float dx = shift_x - p.sx;
...
.LBE2287:
.LBE2371:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:56:         p.A = (1 - dx) * (1 - dy);
...
.LVL32:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:57:         p.B = dx       * (1 - dy);
	.loc 1 57 24 view .LVU143
	vmulss	xmm1, xmm1, xmm3	# _13, _11, dx
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:58:         p.C = (1 - dx) * dy;
	.loc 1 58 24 view .LVU144
	vmulss	xmm0, xmm0, xmm5	# _14, _10, dy
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:59:         p.D = dx       * dy;
...
.LBE2458:
.LBE2457:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:71:     std::vector<int> diff((width + 1) * (height + 1), 0);
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:73:     for (const auto& p : params) {
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:74:         diff[p.y_begin * (width + 1) + p.x_begin] += 1;
...
.LBE2521:
.LBE2520:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:76:         diff[p.y_end   * (width + 1) + p.x_begin] -= 1;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:75:         diff[p.y_begin * (width + 1) + p.x_end  ] -= 1;
...
.LBE2529:
.LBE2528:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:77:         diff[p.y_end   * (width + 1) + p.x_end  ] += 1;
...
.LBB2533:
	...
	mov	rax, QWORD PTR 160[rsp]	# _336, %sfp
.LBE2533:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:81:         int row = 0;
	.loc 1 81 13 is_stmt 0 view .LVU312
	xor	esi, esi	# row
	lea	edx, -1[rax]	# _974,
.LBE2532:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:80:     for (int y = 0; y < h; ++y) {
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:84:             counts[y * w + x] = row + (y > 0 ? counts[(y - 1) * w + x] : 0);
	.loc 1 84 31 is_stmt 0 discriminator 5 view .LVU315
	mov	rdx, QWORD PTR 80[rsp]	# _325, %sfp
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:83:             row += diff[y * (width + 1) + x];
...
.LBB2539:
.LBB2535:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:82:         for (int x = 0; x < w; ++x) {
...
.LBB2629:
.LBB2630:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:124:                     size_t ind_lbot = ind_ltop + width * 3;
...
.LBB2792:
.LBB2793:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:182:                     float inv_c = 1.0f / static_cast<float>(c);
...
.LBE2625:
	...
	mov	r15d, ebx	# ty, _71
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:97:         const int tile_y_end = std::min(ty + TILE_H, h);
...
.LBE2855:
.LBE2860:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:98:         const int tile_h_actual = tile_y_end - ty;
...
.LBB2864:
.LBB2851:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:101:             const int tile_x_end = std::min(tx + TILE_W, w);
...
.LBE2823:
.LBE2826:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:102:             const int tile_w_actual = tile_x_end - tx;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:106:                       tile_vals.begin() + tile_h_actual * tile_w_actual * 3,
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:110:             for (const SubParams& p : params) {
...
.LBB2767:
.LBB2733:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:131:                                 + (x_begin - tx) * 3;
	.loc 1 131 44 is_stmt 0 view .LVU477
	mov	ecx, eax	# _96, _444
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:134:                     const int x_stop = (x_end - tx) * 3;
	.loc 1 134 47 view .LVU478
	sub	edx, ebx	# _101, tx
	mov	esi, esi	# _690, y
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:123:                     size_t ind_ltop = ((y + p.sy) * width + (x_begin + p.sx)) * 3;
...
.LBE2733:
.LBE2767:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:117:                 const __m256 Avx = _mm256_set1_ps(p.A);
...
.LBE2734:
.LBE2768:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:118:                 const __m256 Bvx = _mm256_set1_ps(p.B);
	.loc 1 118 53 view .LVU485
	vmovss	xmm17, DWORD PTR 12[rdi]	# _80, MEM[(float *)_137 + 12B]
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:119:                 const __m256 Cvx = _mm256_set1_ps(p.C);
	.loc 1 119 53 view .LVU486
	vmovss	xmm16, DWORD PTR 16[rdi]	# _81, MEM[(float *)_137 + 16B]
.LBB2769:
.LBB2735:
.LBB2631:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:137:                     for (; x + 8 <= x_stop; x += 8) {
	.loc 1 137 34 discriminator 2 view .LVU487
	lea	edx, 7[r10]	# _221,
.LBE2631:
.LBE2735:
.LBE2769:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:120:                 const __m256 Dvx = _mm256_set1_ps(p.D);
...
.LBE2707:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:125:                     size_t ind_rtop = ind_ltop + 3;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:126:                     size_t ind_rbot = ind_lbot + 3;
...
.LBE2644:
.LBE2643:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:155:                         vp += 8;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:161:                     int remaining = x_stop - x;
...
.LBB2709:
	...
	jle	.L37	#,
.LBB2710:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:163:                         float TL = p.SUB[ind_ltop + k];
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:165:                         float BL = p.SUB[ind_lbot + k];
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:164:                         float TR = p.SUB[ind_rtop + k];
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:167:                         vp[k] += p.A*TL + p.B*TR + p.C*BL + p.D*BR;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:166:                         float BR = p.SUB[ind_rbot + k];
...
.LBE2713:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:162:                     for (int k = 0; k < remaining; ++k) {
...
.LVL162:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:122:                 for (int y = y_begin; y < y_end; ++y) {
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:173:             for (int y = ty; y < tile_y_end; ++y) {
...
.LBE2810:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:175:                 unsigned char* outp = output.data.data() + (y * width + tx) * 3;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:179:                         outp[x*3] = outp[x*3+1] = outp[x*3+2] = 0;
...
.LBE2802:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:176:                 for (int x = 0; x < tile_w_actual; ++x) {
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:177:                     int c = counts[y * width + (tx + x)];
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:184:                         float v = vp[x*3 + ch] * inv_c;
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:185:                         outp[x*3 + ch] = static_cast<unsigned char>(v);
...
.LBE2851:
	...
	add	QWORD PTR 152[rsp], 2032	# %sfp,
.LVL190:
...
.LBE2864:
.LBE2624:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:96:     for (int ty = 0; ty < h; ty += TILE_H) {
...
.LBE2400:
.LBE2908:
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:193: }
...
# src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp:133:                     int x = (x_begin - tx) * 3;
...
.LASF0:
	.string	"src/avx_analysis_code_ablations/opt11_abl_tile_8x2032.cpp"
.LASF1:
