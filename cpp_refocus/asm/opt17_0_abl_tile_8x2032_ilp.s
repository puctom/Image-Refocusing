	.file	"opt17_0_abl_tile_8x2032_ilp.cpp"
...
# options passed: -march=tigerlake -mmmx -mpopcnt -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -mavx -mno-sse4a -mno-fma4 -mno-xop -mavx512f -mbmi -mbmi2 -maes -mpclmul -mavx512vl -mavx512bw -mavx512dq -mavx512cd -mavx512vbmi -mavx512ifma -mavx512vpopcntdq -mavx512vbmi2 -mgfni -mvpclmulqdq -mavx512vnni -mavx512bitalg -mno-avx512bf16 -mavx512vp2intersect -mno-3dnow -madx -mabm -mno-cldemote -mclflushopt -mclwb -mno-clzero -mcx16 -mno-enqcmd -mf16c -mfsgsbase -mfxsr -mno-hle -msahf -mno-lwp -mlzcnt -mmovbe -mmovdir64b -mmovdiri -mno-mwaitx -mno-pconfig -mpku -mprfchw -mno-ptwrite -mrdpid -mrdrnd -mrdseed -mno-rtm -mno-serialize -mno-sgx -msha -mshstk -mno-tbm -mno-tsxldtrk -mvaes -mno-waitpkg -mno-wbnoinvd -mxsave -mxsavec -mxsaveopt -mxsaves -mno-amx-tile -mno-amx-int8 -mno-amx-bf16 -mno-uintr -mno-hreset -mno-kl -mno-widekl -mno-avxvnni -mno-avx512fp16 -mno-avxifma -mno-avxvnniint8 -mno-avxneconvert -mno-cmpccxadd -mno-amx-fp16 -mno-prefetchi -mno-raoint -mno-amx-complex -mno-avxvnniint16 -mno-sm3 -mno-sha512 -mno-sm4 -mno-apxf -mno-usermsr -mno-avx10.1 -mno-avx10.2 -mno-amx-avx512 -mno-amx-tf32 -mno-amx-fp8 -mno-movrs -mno-amx-movrs -mno-avx512bmm --param=l1-cache-size=48 --param=l1-cache-line-size=64 --param=l2-cache-size=8192 -mtune=tigerlake -mavx2 -mfma -masm=intel -g -O3 -std=c++17 -ffast-math -fasynchronous-unwind-tables
	.text
.Ltext0:
	.file 0 "/home/team15/tomasz-worktree-dir/cpp_refocus" "src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp"
...
.LVL0:
.LFB11707:
	.file 1 "src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp"
	.loc 1 35 91 view -0
	.cfi_startproc
...
.LBE2445:
.LBE2444:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:35: ImageData refocus_shift_and_sum(std::vector<SubApertureImage>& subapertures, float focus) {
...
.LBE2466:
.LBE2467:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:36:     const size_t width  = subapertures.front().data.width;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:44:     output.data.assign(width * height * 3, 0);
	.loc 1 44 30 is_stmt 0 view .LVU36
	mov	r14, rax	# _4, _390
	mov	QWORD PTR 224[rsp], rdx	# %sfp, _920
	imul	r14, rdx	# _4, _920
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:42:     output.width = width;
...
.LBE2580:
.LBE2583:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:38:     const int w = static_cast<int>(width);
	.loc 1 38 15 view .LVU68
	mov	eax, DWORD PTR 144[rsp]	# tmp1875, %sfp
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:39:     const int h = static_cast<int>(height);
...
.LBB2703:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:49:     for (auto& sub : subapertures) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:51:         float shift_x = focus * sub.u;
	.loc 1 51 15 is_stmt 0 view .LVU85
	vmovss	xmm5, DWORD PTR 192[rsp]	# focus, %sfp
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:61:         p.x_begin = std::max(0, -p.sx);
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:52:         float shift_y = focus * sub.v;
...
.LBE2593:
.LBE2592:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:53:         p.sx = static_cast<int>(std::floor(shift_x));
...
.LBE2595:
.LBE2594:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:54:         p.sy = static_cast<int>(std::floor(shift_y));
...
.LBE2597:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:62:         p.x_end   = std::min(w, w - p.sx - 1);
...
.LBE2600:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:63:         p.y_begin = std::max(0, -p.sy);
...
.LBE2601:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:64:         p.y_end   = std::min(h, h - p.sy - 1);
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:66:         if (p.x_begin >= p.x_end || p.y_begin >= p.y_end) continue;  // skip degenerate
	...
	jge	.L12	#,
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:56:         float dy = shift_y - p.sy;
	.loc 1 56 15 view .LVU132
	vsubss	xmm5, xmm2, xmm1	# dy, shift_y, _441
.LVL25:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:55:         float dx = shift_x - p.sx;
...
.LBE2609:
.LBE2608:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:57:         p.A = (1 - dx) * (1 - dy);
...
.LVL31:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:58:         p.B = dx       * (1 - dy);
	.loc 1 58 24 view .LVU142
	vmulss	xmm1, xmm1, xmm3	# _13, _11, dx
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:59:         p.C = (1 - dx) * dy;
	.loc 1 59 24 view .LVU143
	vmulss	xmm0, xmm0, xmm5	# _14, _10, dy
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:60:         p.D = dx       * dy;
...
.LBE2780:
.LBE2779:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:72:     std::vector<int> diff((width + 1) * (height + 1), 0);
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:74:     for (const auto& p : params) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:75:         diff[p.y_begin * (width + 1) + p.x_begin] += 1;
...
.LBE2843:
.LBE2842:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:77:         diff[p.y_end   * (width + 1) + p.x_begin] -= 1;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:76:         diff[p.y_begin * (width + 1) + p.x_end  ] -= 1;
...
.LBE2851:
.LBE2850:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:78:         diff[p.y_end   * (width + 1) + p.x_end  ] += 1;
...
.LBB2855:
	...
	mov	rax, QWORD PTR 144[rsp]	# _390, %sfp
.LBE2855:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:82:         int row = 0;
	.loc 1 82 13 is_stmt 0 view .LVU311
	xor	esi, esi	# row
	lea	edx, -1[rax]	# _1094,
.LBE2854:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:81:     for (int y = 0; y < h; ++y) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:85:             counts[y * w + x] = row + (y > 0 ? counts[(y - 1) * w + x] : 0);
	.loc 1 85 31 is_stmt 0 discriminator 5 view .LVU314
	mov	rdi, QWORD PTR 64[rsp]	# _379, %sfp
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:84:             row += diff[y * (width + 1) + x];
...
.LBB2861:
.LBB2857:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:83:         for (int x = 0; x < w; ++x) {
...
.LBB2916:
.LBB2917:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:125:                     size_t ind_lbot = ind_ltop + width * 3;
...
.LBB3210:
.LBB3211:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:227:                     float inv_c = 1.0f / static_cast<float>(c);
...
.LBE2912:
	...
	mov	r15d, ebx	# ty, _71
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:98:         const int tile_y_end = std::min(ty + TILE_H, h);
...
.LBE3272:
.LBE3277:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:99:         const int tile_h_actual = tile_y_end - ty;
...
.LBB3281:
.LBB3268:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:102:             const int tile_x_end = std::min(tx + TILE_W, w);
...
.LBE3240:
.LBE3243:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:103:             const int tile_w_actual = tile_x_end - tx;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:107:                       tile_vals.begin() + tile_h_actual * tile_w_actual * 3,
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:111:             for (const SubParams& p : params) {
...
.LBB3186:
.LBB3153:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:132:                                 + (x_begin - tx) * 3;
	.loc 1 132 44 is_stmt 0 view .LVU474
	mov	ecx, eax	# _96, _155
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:135:                     const int x_stop = (x_end - tx) * 3;
	.loc 1 135 47 view .LVU475
	sub	edx, ebx	# _101, tx
	mov	esi, edi	# _689, y
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:124:                     size_t ind_ltop = ((y + p.sy) * width + (x_begin + p.sx)) * 3;
...
.LBE3153:
.LBE3186:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:118:                 const __m256 Avx = _mm256_set1_ps(p.A);
...
.LBE3154:
.LBE3187:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:119:                 const __m256 Bvx = _mm256_set1_ps(p.B);
	.loc 1 119 53 view .LVU482
	vmovss	xmm17, DWORD PTR 12[r15]	# _80, MEM[(float *)_160 + 12B]
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:120:                 const __m256 Cvx = _mm256_set1_ps(p.C);
	.loc 1 120 53 view .LVU483
	vmovss	xmm16, DWORD PTR 16[r15]	# _81, MEM[(float *)_160 + 16B]
.LBB3188:
.LBB3155:
.LBB2918:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:139:                     for (; x + 16 <= x_stop; x += 16) {
	.loc 1 139 35 discriminator 2 view .LVU484
	lea	edx, 15[r9]	# _244,
.LBE2918:
.LBE3155:
.LBE3188:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:121:                 const __m256 Dvx = _mm256_set1_ps(p.D);
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:127:                     size_t ind_rbot = ind_lbot + 3;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:126:                     size_t ind_rtop = ind_ltop + 3;
...
.LBE2931:
.LBE2930:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:178:                         vp += 16;
...
.LBB3064:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:182:                     if(x + 8 <= x_stop) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:183:                         __m128i ltop_b = _mm_loadl_epi64(reinterpret_cast<const __m128i*>(p.SUB + ind_ltop));
	.loc 1 183 93 is_stmt 0 view .LVU729
	mov	rbx, QWORD PTR 224[rsp]	# ivtmp.567, %sfp
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:200:                         vp += 8;
	.loc 1 200 28 view .LVU730
	add	rax, 32	# vp,
.LVL124:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:203:                         x += 8;
...
.LBE3096:
.LBE3095:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:201:                         ind_ltop += 8; ind_lbot += 8;
	.loc 1 201 34 view .LVU772
	add	rdx, 8	# ivtmp.556,
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:202:                         ind_rtop += 8; ind_rbot += 8;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:206:                     int remaining = x_stop - x;
...
.LBB3132:
	...
	jle	.L39	#,
.LBB3133:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:208:                         float TL = p.SUB[ind_ltop + k];
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:210:                         float BL = p.SUB[ind_lbot + k];
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:209:                         float TR = p.SUB[ind_rtop + k];
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:212:                         vp[k] += p.A*TL + p.B*TR + p.C*BL + p.D*BR;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:211:                         float BR = p.SUB[ind_rbot + k];
...
.LBE3136:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:207:                     for (int k = 0; k < remaining; ++k) {
...
.LVL164:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:123:                 for (int y = y_begin; y < y_end; ++y) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:218:             for (int y = ty; y < tile_y_end; ++y) {
...
.LBE3228:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:220:                 unsigned char* outp = output.data.data() + (y * width + tx) * 3;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:224:                         outp[x*3] = outp[x*3+1] = outp[x*3+2] = 0;
...
.LBE3220:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:221:                 for (int x = 0; x < tile_w_actual; ++x) {
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:222:                     int c = counts[y * width + (tx + x)];
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:229:                         float v = vp[x*3 + ch] * inv_c;
...
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:230:                         outp[x*3 + ch] = static_cast<unsigned char>(v);
...
.LBE3268:
	...
	add	QWORD PTR 136[rsp], 2032	# %sfp,
.LVL193:
...
.LBE3281:
.LBE2911:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:97:     for (int ty = 0; ty < h; ty += TILE_H) {
...
.LBE2722:
.LBE3325:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:238: }
...
.LBB3203:
.LBB3160:
# src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp:134:                     int x = (x_begin - tx) * 3;
...
.LASF0:
	.string	"src/avx_analysis_code_ablations/opt17_0_abl_tile_8x2032_ilp.cpp"
.LASF1:
