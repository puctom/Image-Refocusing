        ...
        for (int tx = 0; tx < w; tx += TILE_W) {
            ...
            for (const SubParams& p : params) {
                ...
                for (int y = y_begin; y < y_end; ++y) {
                    ...
                    //     __m128i ltop_b0 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_ltop)
                    //     );
                    //     __m128i rtop_b0 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_rtop)
                    //     );
                    //     __m128i lbot_b0 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_lbot)
                    //     );
                    //     __m128i rbot_b0 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_rbot)
                    //     );

                    //     __m128i ltop_b1 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_ltop + 16)
                    //     );
                    //     __m128i rtop_b1 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_rtop + 16)
                    //     );
                    //     __m128i lbot_b1 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_lbot + 16)
                    //     );
                    //     __m128i rbot_b1 = _mm_loadu_si128(
                    //         reinterpret_cast<const __m128i*>(p.SUB + ind_rbot + 16)
                    //     );
                    ...
                    //         reinterpret_cast<const __m256i*>(vp)
                    //     );
                    //     __m256i acc1 = _mm256_loadu_si256(
                    //         reinterpret_cast<const __m256i*>(vp + 16)
                    //     );
                    ...
                    //     _mm256_storeu_si256(
                    //         reinterpret_cast<__m256i*>(vp),
                    //         acc0
                    //     );
                    //     _mm256_storeu_si256(
                    //         reinterpret_cast<__m256i*>(vp + 16),
                    //         acc1
                    //     );
