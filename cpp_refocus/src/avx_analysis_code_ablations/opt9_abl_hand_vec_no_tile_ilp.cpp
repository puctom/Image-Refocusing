...
/*
*   Ablation: opt12.cpp with tiling removed (single full-image accumulator).
*   Inner loop is identical to opt12 (ILP x-unrolling); only the outer tile structure is absent.
*
