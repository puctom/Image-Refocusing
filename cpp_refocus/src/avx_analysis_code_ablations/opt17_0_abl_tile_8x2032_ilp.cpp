...
/*
*   Ablation 5: Hand-vectorized AVX2 + 8x2032 tile + ILP x-unrolling, no row reuse.
*   The x-loop processes 16 floats per iteration (two independent AVX register pairs,
*   _lo and _hi) to keep more execution units busy via instruction-level parallelism.
*   One output row at a time — no register sharing between rows.
* */
