...
/*
*   Ablation 4: Hand-vectorized AVX2 + prefix-sum counts + 8x2032 output tile.
*   Wider tile (8*2032*3*4 = ~195 KB) amortizes tile-loop overhead and allows
*   better use of cache prefetching across the full row width.
*   Inner loop identical to ablation 3 (8 floats per step, no ILP unroll).
* */
